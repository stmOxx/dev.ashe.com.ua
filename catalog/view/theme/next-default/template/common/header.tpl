        ...
        <div id="top-link" class="nav pull-left">
            <ul class="list-inline">
                <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>"
                            ...
                            class="hidden-xs hidden-sm"><?php echo $text_account; ?></span> <span class="caret"></span></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class='data_open'><i class="fa fa-clock-o" aria-hidden="true"></i> <span
                            class=""><?php echo $open; ?></span></div>
                </div>
